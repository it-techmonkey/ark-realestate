...
const events: EventListing[] = [
  ...
  },
  {
    ...
    excerpt: "Join us in Kolkata at JW Marriott for the Danube event, featuring exclusive property showcases and investment opportunities.",
    imageSrc: "/Events/Kolkata.jpg",
    timeZone: "Asia/Kolkata",
    timeZoneLabel: "Kolkata (IST)",
    badge: "Regional event",
  },
  {
    title: "18 & 19 July Hyderabad - Danube event",
    ...
    excerpt: "Join us in Hyderabad at Park Hyatt for the Danube event, featuring exclusive property showcases and investment opportunities across the weekend.",
    imageSrc: "/Events/Hyderabad.jpg",
    timeZone: "Asia/Kolkata",
    timeZoneLabel: "Hyderabad (IST)",
    badge: "Regional event",
  },
  {
    title: "11 & 12 July Trichy / Chennai",
    dates: ["2026-07-11", "2026-07-12"],
    scheduleSummary: "Two-day property exhibition — session timings shared after registration",
    location: "Trichy or Chennai",
    excerpt: "Meet ARK Vision for a curated property expo — developer showcases, investment walkthroughs, and one-to-one advisory across the weekend.",
    imageSrc: "/Events/Chennai.jpg",
    timeZone: "Asia/Kolkata",
    timeZoneLabel: "India (IST)",
    badge: "Regional event",
  },
  {
    title: "4 & 5 July Bengaluru - Coffee Event",
    dates: ["2026-07-04", "2026-07-05"],
    scheduleSummary: "Two-day property exhibition — session timings shared after registration",
    location: "Bengaluru",
    excerpt: "Meet ARK Vision in Bengaluru for a special Coffee Event, featuring expert investment guidance and one-to-one advisory across the weekend.",
    imageSrc: "/Events/Bangalore.jpg",
    timeZone: "Asia/Kolkata",
  ...
  },
  {
    ...
    scheduleSummary: "Two-day property exhibition — session timings shared after registration",
    location:
      "Imtiaz Sales Center, Suite 303, Park Heights Square 1, Dubai Hills, Dubai, United Arab Emirates",
    excerpt:
      "Join ARK Vision at the Imtiaz Sales Center for a curated property exhibition, expert investment guidance, and one-to-one advisory across the weekend.",
    imageSrc: "/dubai%20image.jpg",
  },
  {
